...
<div class="w3-container" style="padding:128px 16px" id="ourcostumers">
  ...
  <div class="w3-row-padding " style="margin-top:64px">
    ...
    <div class="form-group">
      <input type="text" class="form-control" id="exampleInputEmail1" name="title_article" placeholder="Title Article" style="width: 100%;">
      <br/>
    </div>
    <div class="form-group">
      <textarea class="ckeditor form-control " id="ckedtor" name="content"></textarea>
    </div>
    <center>
